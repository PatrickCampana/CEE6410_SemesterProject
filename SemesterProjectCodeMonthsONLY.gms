...
*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$2$$$$$$$$
 TotRelease Total Volume of Water Released Over Model Period / 7500000/;
*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$2$$$$$$$$
...
*constraint in June
          ...
          Enviro2.. X('Dam','M18')=G= Env('Y2')*EnviroFlows('Y2','W1');
          Enviro3.. X('Dam','M30')=G= Env('Y3')*EnviroFlows('Y3','W1');
          Enviro4.. X('Dam','M42')=G= Env('Y4')*EnviroFlows('Y4','W1');
          Enviro5.. X('Dam','M54')=G= Env('Y5')*EnviroFlows('Y5','W1');
